...
use schellingcoin_runtime::{self, opaque::Block, GenesisConfig, RuntimeApi};
use std::sync::Arc;
...
native_executor_instance!(
	pub Executor,
	schellingcoin_runtime::api::dispatch,
	schellingcoin_runtime::native_version,
	include_bytes!("../runtime/wasm/target/wasm32-unknown-unknown/release/schellingcoin_runtime_wasm.compact.wasm")
);
